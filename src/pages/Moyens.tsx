...
const Moyens = () => {
  ...
  return (
    <Layout>
      ...
      {/* Cooperative Section */}
      {isSectionVisible(content, "cooperative") && (
        <section className="py-20">
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-2xl overflow-hidden">
                <img src={getContent(content, "cooperative", "image", "") || farmerImage} alt="Coopérative agricole" className="w-full h-[400px] object-cover" />
      ...
      {/* Restaurant Section */}
      {isSectionVisible(content, "restaurant") && (
          ...
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 relative rounded-2xl overflow-hidden">
                <img src={getContent(content, "restaurant", "image", "") || restaurantImage} alt="Restaurant Les Délices du Gabon" className="w-full h-[400px] object-cover" />
      ...
      {/* Cultural Section */}
      {isSectionVisible(content, "culture") && (
        <section className="py-20">
          <div className="section-container">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-2xl overflow-hidden">
                <img src={getContent(content, "culture", "image", "") || culturalImage} alt="Groupe culturel" className="w-full h-[400px] object-cover" />
